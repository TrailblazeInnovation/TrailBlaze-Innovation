    ...
    formContainer.innerHTML = `
      ...
      <div class="steps" style="display: flex; gap: 30px; justify-content: space-around; width: 100%;">
        ...
        <div class="step-indicator step-1">
          <span class="bord2"></span><span class="bord"></span>
          <span style="background-color: rgb(218 213 213 / 0%); border: 1px solid; width: 34px; text-align: center; display: inline-flex; align-items: center; height: 34px; justify-content: center; border-radius: 50%;">1</span>
        </div>
        <div class="step-indicator step-2">
          <span class="bord"></span>
          <span style="background-color: rgb(218 213 213 / 0%); border: 1px solid; width: 34px; text-align: center; display: inline-flex; align-items: center; height: 34px; justify-content: center; border-radius: 50%;">2</span>
        </div>
        <div class="step-indicator step-3">
          <span class="bord"></span>
          <span style="background-color: rgb(218 213 213 / 0%); border: 1px solid; width: 34px; text-align: center; display: inline-flex; align-items: center; height: 34px; justify-content: center; border-radius: 50%;">3</span>
        </div>
      </div>
    ...
    function updateReviewInfo() {
      ...
      reviewInfo.innerHTML = \`
        <div style="background: #F5F5F7; padding: 10px; border-radius: 5px; margin-top: 20px;">
          <div><h2 style="margin: 0!important;">Contact Information</h2></div>
          <div><p style="font-family: 'Host Grotesk', serif;">First and Last Name: <br/><span style="color: gray;">\${formContainer.querySelector(".name").value} \${formContainer.querySelector(".Lastname").value}</span></p></div>
          <div><p style="font-family: 'Host Grotesk', serif;">Email: <br/><span style="color: gray;">\${formContainer.querySelector(".email").value}</span></p></div>
          <div><p style="font-family: 'Host Grotesk', serif;">Phone Number: <br/><span style="color: gray;">\${formContainer.querySelector(".phone").value}</span></p></div>
        </div>
        <div style="background: #F5F5F7; padding: 10px; border-radius: 5px; margin-top: 20px;">
          <div><h2 style="margin: 0!important;">Concerns</h2></div>
          <div><p style="font-family: 'Host Grotesk', serif;">Message: <br/><span style="color: gray;">\${formContainer.querySelector(".Message").value}</span></p></div>
        </div>
      \`;
    }
